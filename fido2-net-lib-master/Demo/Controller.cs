    ...
    public class MyController : Controller
    {
                                                ...
                                                [FromForm] string userVerification)
        {
            try
            {
                ...
                CredentialCreateOptions options = _fido2.RequestNewCredential(user, existingKeys, authenticatorSelection, attType.ToEnum<AttestationConveyancePreference>(), exts);
